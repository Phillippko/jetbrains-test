...
public class MessageService {
    ...
    public void sendMessage(MessageIncomingDto messageIncomingDto) {
        Template template = templateService.getTemplateById(messageIncomingDto.getTemplateId());
        String messageText = templateService.fillTemplate(template, messageIncomingDto.getVariables());
